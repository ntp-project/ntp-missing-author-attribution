 ...
 *
 *  It has been AutoGen-ed  October 17, 2015 at 06:17:04 AM by AutoGen 5.18.5
...
#define zLicenseDescrip (sntp_opt_strs+348)
 ...
 */
static char const sntp_opt_strs[2573] =
/*     0 */ "sntp 4.2.8p4-sec-RC2\n"
            "Copyright (C) 1992-2015 The University of Delaware and Network Time Foundation, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the NTP License, copies of which\n"
            "can be seen at:\n"
...
/*  1088 */ "IPV6\0"
/*  1093 */ "ipv6\0"
/*  1098 */ "Enable authentication with the key auth-keynumber\0"
/*  1148 */ "AUTHENTICATION\0"
/*  1163 */ "authentication\0"
/*  1178 */ "Listen to the address specified for broadcast time sync\0"
/*  1234 */ "BROADCAST\0"
/*  1244 */ "broadcast\0"
/*  1254 */ "Concurrently query all IPs returned for host-name\0"
/*  1304 */ "CONCURRENT\0"
/*  1315 */ "concurrent\0"
/*  1326 */ "Increase debug verbosity level\0"
/*  1357 */ "DEBUG_LEVEL\0"
/*  1369 */ "debug-level\0"
/*  1381 */ "Set the debug verbosity level\0"
/*  1411 */ "SET_DEBUG_LEVEL\0"
/*  1427 */ "set-debug-level\0"
/*  1443 */ "The gap (in milliseconds) between time requests\0"
/*  1491 */ "GAP\0"
/*  1495 */ "gap\0"
/*  1499 */ "KoD history filename\0"
/*  1520 */ "KOD\0"
/*  1524 */ "kod\0"
/*  1528 */ "/var/db/ntp-kod\0"
/*  1544 */ "Look in this file for the key specified with -a\0"
/*  1592 */ "KEYFILE\0"
/*  1600 */ "keyfile\0"
/*  1608 */ "Log to specified logfile\0"
/*  1633 */ "LOGFILE\0"
/*  1641 */ "logfile\0"
/*  1649 */ "Adjustments less than steplimit msec will be slewed\0"
/*  1701 */ "STEPLIMIT\0"
/*  1711 */ "steplimit\0"
/*  1721 */ "Send int as our NTP protocol version\0"
/*  1758 */ "NTPVERSION\0"
/*  1769 */ "ntpversion\0"
/*  1780 */ "Use the NTP Reserved Port (port 123)\0"
/*  1817 */ "USERESERVEDPORT\0"
/*  1833 */ "usereservedport\0"
/*  1849 */ "OK to 'step' the time with settimeofday(2)\0"
/*  1892 */ "STEP\0"
/*  1897 */ "step\0"
/*  1902 */ "OK to 'slew' the time with adjtime(2)\0"
/*  1940 */ "SLEW\0"
/*  1945 */ "slew\0"
/*  1950 */ "The number of seconds to wait for responses\0"
/*  1994 */ "TIMEOUT\0"
/*  2002 */ "timeout\0"
/*  2010 */ "Wait for pending replies (if not setting the time)\0"
/*  2061 */ "WAIT\0"
/*  2066 */ "no-wait\0"
/*  2074 */ "no\0"
/*  2077 */ "display extended usage information and exit\0"
/*  2121 */ "help\0"
/*  2126 */ "extended usage information passed thru pager\0"
/*  2171 */ "more-help\0"
/*  2181 */ "output version information and exit\0"
/*  2217 */ "version\0"
/*  2225 */ "save the option state to a config file\0"
/*  2264 */ "save-opts\0"
/*  2274 */ "load options from a config file\0"
/*  2306 */ "LOAD_OPTS\0"
/*  2316 */ "no-load-opts\0"
/*  2329 */ "SNTP\0"
/*  2334 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p4-sec-RC2\n"
...
#define IPV4_DESC      (sntp_opt_strs+1016)
/** Upper-cased name for the ipv4 option */
#define IPV4_NAME      (sntp_opt_strs+1047)
/** Name string for the ipv4 option */
#define IPV4_name      (sntp_opt_strs+1052)
...
#define IPV6_DESC      (sntp_opt_strs+1057)
/** Upper-cased name for the ipv6 option */
#define IPV6_NAME      (sntp_opt_strs+1088)
/** Name string for the ipv6 option */
#define IPV6_name      (sntp_opt_strs+1093)
...
#define AUTHENTICATION_DESC      (sntp_opt_strs+1098)
/** Upper-cased name for the authentication option */
#define AUTHENTICATION_NAME      (sntp_opt_strs+1148)
/** Name string for the authentication option */
#define AUTHENTICATION_name      (sntp_opt_strs+1163)
...
#define CONCURRENT_DESC      (sntp_opt_strs+1254)
/** Upper-cased name for the concurrent option */
#define CONCURRENT_NAME      (sntp_opt_strs+1304)
/** Name string for the concurrent option */
#define CONCURRENT_name      (sntp_opt_strs+1315)
...
#define DEBUG_LEVEL_DESC      (sntp_opt_strs+1326)
/** Upper-cased name for the debug-level option */
#define DEBUG_LEVEL_NAME      (sntp_opt_strs+1357)
/** Name string for the debug-level option */
#define DEBUG_LEVEL_name      (sntp_opt_strs+1369)
...
#define SET_DEBUG_LEVEL_DESC      (sntp_opt_strs+1381)
/** Upper-cased name for the set-debug-level option */
#define SET_DEBUG_LEVEL_NAME      (sntp_opt_strs+1411)
/** Name string for the set-debug-level option */
#define SET_DEBUG_LEVEL_name      (sntp_opt_strs+1427)
...
#define NTPVERSION_DESC      (sntp_opt_strs+1721)
/** Upper-cased name for the ntpversion option */
#define NTPVERSION_NAME      (sntp_opt_strs+1758)
...
#define USERESERVEDPORT_DESC      (sntp_opt_strs+1780)
/** Upper-cased name for the usereservedport option */
#define USERESERVEDPORT_NAME      (sntp_opt_strs+1817)
/** Name string for the usereservedport option */
#define USERESERVEDPORT_name      (sntp_opt_strs+1833)
...
#define STEP_DESC      (sntp_opt_strs+1849)
/** Upper-cased name for the step option */
#define STEP_NAME      (sntp_opt_strs+1892)
...
#define SLEW_DESC      (sntp_opt_strs+1902)
/** Upper-cased name for the slew option */
#define SLEW_NAME      (sntp_opt_strs+1940)
...
#define WAIT_DESC      (sntp_opt_strs+2010)
/** Upper-cased name for the wait option */
#define WAIT_NAME      (sntp_opt_strs+2061)
/** disablement name for the wait option */
#define NOT_WAIT_name  (sntp_opt_strs+2066)
/** disablement prefix for the wait option */
#define NOT_WAIT_PFX   (sntp_opt_strs+2074)
 ...
 */
#define HELP_DESC       (sntp_opt_strs+2077)
#define HELP_name       (sntp_opt_strs+2121)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (sntp_opt_strs+2126)
#define MORE_HELP_name  (sntp_opt_strs+2171)
...
#endif
#define VER_DESC        (sntp_opt_strs+2181)
#define VER_name        (sntp_opt_strs+2217)
#define SAVE_OPTS_DESC  (sntp_opt_strs+2225)
#define SAVE_OPTS_name  (sntp_opt_strs+2264)
#define LOAD_OPTS_DESC     (sntp_opt_strs+2274)
#define LOAD_OPTS_NAME     (sntp_opt_strs+2306)
#define NO_LOAD_OPTS_name  (sntp_opt_strs+2316)
#define LOAD_OPTS_pfx      (sntp_opt_strs+2074)
...
#define zPROGNAME       (sntp_opt_strs+2329)
/** Reference to the title line for sntp usage. */
#define zUsageTitle     (sntp_opt_strs+2334)
