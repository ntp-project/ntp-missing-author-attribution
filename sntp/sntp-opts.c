 ...
 *
 *  It has been AutoGen-ed  December  5, 2015 at 11:49:31 AM by AutoGen 5.18.5
...
/*  2307 */ "no-load-opts\0"
/*  2320 */ "SNTP\0"
/*  2325 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.3.87\n"
...
implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.3.87\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
