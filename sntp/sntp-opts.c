 ...
 *
 *  It has been AutoGen-ed  October  6, 2015 at 05:54:01 AM by AutoGen 5.18.5
...
/*  2312 */ "no-load-opts\0"
/*  2325 */ "SNTP\0"
/*  2330 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p4-RC1\n"
...
implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p4-RC1\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
