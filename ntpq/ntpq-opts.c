 ...
 *
 *  It has been AutoGen-ed  June 24, 2015 at 04:10:22 PM by AutoGen 5.18.5
...
/*  1735 */ "no\0"
/*  1738 */ "NTPQ\0"
/*  1743 */ "ntpq - standard NTP query program - Ver. 4.3.45\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.3.45\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
