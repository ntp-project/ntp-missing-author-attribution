 ...
 *
 *  It has been AutoGen-ed  June  7, 2015 at 11:58:34 AM by AutoGen 5.18.5
...
/*  1735 */ "no\0"
/*  1738 */ "NTPQ\0"
/*  1743 */ "ntpq - standard NTP query program - Ver. 4.3.36\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.3.36\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
