 ...
 *
 *  It has been AutoGen-ed  November  7, 2015 at 03:58:21 AM by AutoGen 5.18.5
...
/*  1735 */ "no\0"
/*  1738 */ "NTPQ\0"
/*  1743 */ "ntpq - standard NTP query program - Ver. 4.3.78\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.3.78\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
