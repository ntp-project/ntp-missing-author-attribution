 ...
 *
 *  It has been AutoGen-ed  October  1, 2015 at 11:57:32 AM by AutoGen 5.18.5
...
/*  1706 */ "no\0"
/*  1709 */ "NTPDC\0"
/*  1715 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.3.75\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.3.75\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
