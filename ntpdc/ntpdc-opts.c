 ...
 *
 *  It has been AutoGen-ed  June 27, 2015 at 05:20:01 AM by AutoGen 5.18.5
...
/*  1711 */ "no\0"
/*  1714 */ "NTPDC\0"
/*  1720 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.8p3-RC3\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.8p3-RC3\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
