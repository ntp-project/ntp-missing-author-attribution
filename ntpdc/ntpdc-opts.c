 ...
 *
 *  It has been AutoGen-ed  December  2, 2015 at 12:16:24 PM by AutoGen 5.18.5
...
/*  1706 */ "no\0"
/*  1709 */ "NTPDC\0"
/*  1715 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.3.85\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.3.85\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
