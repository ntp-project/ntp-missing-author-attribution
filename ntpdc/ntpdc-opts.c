 ...
 *
 *  It has been AutoGen-ed  June 12, 2015 at 11:57:13 AM by AutoGen 5.18.5
...
/*  1706 */ "no\0"
/*  1709 */ "NTPDC\0"
/*  1715 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.3.39\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.3.39\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
