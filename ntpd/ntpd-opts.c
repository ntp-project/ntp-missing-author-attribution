 ...
 *
 *  It has been AutoGen-ed  June 27, 2015 at 05:17:28 AM by AutoGen 5.18.5
...
/*  2940 */ "version\0"
/*  2948 */ "NTPD\0"
/*  2953 */ "ntpd - NTP daemon program - Ver. 4.2.8p3-RC3\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n"
            "\t\t[ <server1> ... <serverN> ]\n\0"
/*  3088 */ "http://bugs.ntp.org, bugs@ntp.org\0"
/*  3122 */ "\n\0"
/*  3124 */ "ntpd 4.2.8p3-RC3";
...
implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.2.8p3-RC3\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
