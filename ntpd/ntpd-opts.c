 ...
 *
 *  It has been AutoGen-ed  November  7, 2015 at 03:55:24 AM by AutoGen 5.18.5
...
/*  2935 */ "version\0"
/*  2943 */ "NTPD\0"
/*  2948 */ "ntpd - NTP daemon program - Ver. 4.3.78\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.3.78\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
