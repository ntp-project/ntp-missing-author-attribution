 ...
 *
 *  It has been AutoGen-ed  June 25, 2015 at 11:58:38 AM by AutoGen 5.18.5
...
/*  1426 */ "no\0"
/*  1429 */ "NTPSNMPD\0"
/*  1438 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.46\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.46\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
