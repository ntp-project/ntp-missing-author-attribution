 ...
 *
 *  It has been AutoGen-ed  October  6, 2015 at 06:11:02 AM by AutoGen 5.18.5
...
/*  1431 */ "no\0"
/*  1434 */ "NTPSNMPD\0"
/*  1443 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.8p4-RC1\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.8p4-RC1\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
