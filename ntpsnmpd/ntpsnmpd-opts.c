 ...
 *
 *  It has been AutoGen-ed  June 27, 2015 at 05:20:53 AM by AutoGen 5.18.5
...
/*  1431 */ "no\0"
/*  1434 */ "NTPSNMPD\0"
/*  1443 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.8p3-RC3\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.8p3-RC3\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
