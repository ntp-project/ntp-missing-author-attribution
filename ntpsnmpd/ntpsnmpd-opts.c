 ...
 *
 *  It has been AutoGen-ed  June 21, 2015 at 12:02:51 PM by AutoGen 5.18.5
...
/*  1426 */ "no\0"
/*  1429 */ "NTPSNMPD\0"
/*  1438 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.43\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.43\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
