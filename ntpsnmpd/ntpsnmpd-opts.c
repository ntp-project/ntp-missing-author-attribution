 ...
 *
 *  It has been AutoGen-ed  October  1, 2015 at 11:58:23 AM by AutoGen 5.18.5
...
/*  1426 */ "no\0"
/*  1429 */ "NTPSNMPD\0"
/*  1438 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.75\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.75\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
