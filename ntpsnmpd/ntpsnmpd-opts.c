 ...
 *
 *  It has been AutoGen-ed  June  7, 2015 at 11:59:09 AM by AutoGen 5.18.5
...
/*  1426 */ "no\0"
/*  1429 */ "NTPSNMPD\0"
/*  1438 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.36\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.36\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
