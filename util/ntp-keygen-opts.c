 ...
 *
 *  It has been AutoGen-ed  October  1, 2015 at 11:58:41 AM by AutoGen 5.18.5
...
/*  2214 */ "no\0"
/*  2217 */ "NTP_KEYGEN\0"
/*  2228 */ "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.3.75\n"
...
implied warranty.\n"));
  ...
  puts(_("ntp-keygen (ntp) - Create a NTP host key - Ver. 4.3.75\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
