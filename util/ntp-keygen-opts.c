 ...
 *
 *  It has been AutoGen-ed  October  6, 2015 at 06:17:13 AM by AutoGen 5.18.5
...
/*  2219 */ "no\0"
/*  2222 */ "NTP_KEYGEN\0"
/*  2233 */ "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.8p4-RC1\n"
...
/*  2400 */ "\n\0"
/*  2402 */ "ntp-keygen (ntp) 4.2.8p4-RC1";
...
static void bogus_function(void) {
  ...
  puts(_("ntp-keygen (ntp) 4.2.8p4-RC1\n\
Copyright (C) 1992-2015 The University of Delaware and Network Time Foundation, all rights reserved.\n\
This is free software. It is licensed for use, modification and\n\
redistribution under the terms of the NTP License, copies of which\n\
can be seen at:\n"));
...
implied warranty.\n"));
  ...
  puts(_("ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.8p4-RC1\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
